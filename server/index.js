...
app.get(`/addtask_2`,(req,res)=>{
   ...
   const mysql = "select * from addtask where status = true"
...
app.delete(`/delete/:id_1`,(req,res)=>{
...
app.post(`/Add_name`,(req,res)=>{
    ...
    const input=req.body.input;
    const sql = `SELECT task,addtask.id,addtask.id_1 FROM addtask inner JOIN list ON list.id_1=addtask.id_1 WHERE addtask.id_1 =${id_1} and addtask.status = false and addtask.importent = false`
